...
class DetectCommand(BaseCommand):
    ...
    def add_arguments(self, parser: ArgumentParser):
        parser.add_argument(
            ...
            type=str,
            default=getattr(settings, "DETECTOR_LOGGER_FILENAME"),
        )
        parser.add_argument(
            "--logger",
            help="Type of logger",
    ...
    def handle(self, *args, **options):
        ...
        verbose = options.get("verbose", getattr(settings, "DETECTOR_VERBOSE"))
        detector_file = options.get("detector_file", getattr(settings, "DETECTOR_FILE"))
